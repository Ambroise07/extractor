...
class PDFExtractor(PdfReader):
    ...
    def __init__(self, src, dest: str, callback, page_number: int = -1, **args):
        """
    ...
    def async_extract_text(self):
        ...
        limit: now extracting text with pypdf is not fully achievable.
               because some page have text inside pictures. 

               This will be only perfomed by premium_pdf_extractor. 
